...
"""
Reads a given gaussian input file, changes the number of given cores and available
memory of the current system and writes an altered input file. This file is read
by g09 program and a qm calculation is performed.
"""
...
gau = aggau.GauStuff(nproc=get_real_cores(), mem=get_real_memory())
