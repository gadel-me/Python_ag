...
parser.add_argument("-dcd", default=None, metavar="foo.dcd", help="CHARMM dcd file.")
...
parser.add_argument("-guess_atoms", action="store_true", help="Guess atoms by mass.")
...
sys.replicate_cell(
    n_start=args.a[0], n_stop=args.a[1], direction="a", frame_id=-1, adjust_box=True
)
sys.replicate_cell(
    n_start=args.b[0], n_stop=args.b[1], direction="b", frame_id=-1, adjust_box=True
)
sys.replicate_cell(
    n_start=args.c[0], n_stop=args.c[1], direction="c", frame_id=-1, adjust_box=True
)
