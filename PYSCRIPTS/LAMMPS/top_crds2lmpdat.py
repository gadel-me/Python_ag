    ...
    with open(cif_file) as f_open:
        ...
        while line != "":
            if "_cell_volume" in line:
                ...
                "_cell_measurement_temperature" in line
                or "_diffrn_ambient_temperature" in line
            ):
        ...
        return {
            ...
            "cell_formula_units": cell_formula_units,
            "cell_measurement_temperature": cell_measurement_temperature,
            "density": density,
        }
...
if __name__ == "__main__":
    ...
    coords.add_argument(
        "-xyz", default=None, metavar="bar.xyz", help="XYZ file. Provides coordinates.",
    )
    ...
    parser.add_argument(
        "-sysname", metavar="UNK", default="UNK", help="Name of the molecule/system"
    )
    ...
    if args.cell_by_coordfile is True:
        if sys_coords.ts_boxes == []:
            print(
                "***Warning: Coordinate file has no box info! Guessing cell by coordinates"
            )
    ...
    if args.cell is not None:
        ...
        if sys_topo_ff.ts_boxes == []:
            ...
            sys_topo_ff.ts_boxes[0] = mdb.Box(
                boxtype="lattice",
                ltc_a=a,
                ltc_b=b,
                ltc_c=c,
