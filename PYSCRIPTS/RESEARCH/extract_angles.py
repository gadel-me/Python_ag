...
parser.add_argument("-start", default=0, help="First frame to start analysis with.")
...
with open(args.out, "w") as f_out:
    f_out.write(
        "{:>9}{:>17}{:>17}{:>17}{:>17}\n".format(
            "Step", "ang_C13_N8_C5", "ang_C13_N8_C9", "ang_C9_N8_C5", "ang_b1_N8_b2"
        )
    )
    ...
    for n, frame in enumerate(cbz.ts_coords[args.start :]):
        ...
        ang_C13_N8_C5 = cgt.angle_between_vectors(
            frame[24] - frame[15], frame[24] - frame[7]
        )
        ang_C13_N8_C9 = cgt.angle_between_vectors(
            frame[24] - frame[15], frame[24] - frame[25]
        )
        ang_C9_N8_C5 = cgt.angle_between_vectors(
            frame[24] - frame[25], frame[24] - frame[7]
        )
        ...
        com_b2 = agg.get_com(
            [frame[6], frame[4], frame[0], frame[2], frame[8], frame[7]],
            [
        ...
        # azepine dihedral
        dih_C13_C12_C15_C7 = agg.get_dihedral(
            frame[15], frame[14], frame[12], frame[10]
        )
        ang_C13_N8_C5, ang_C13_N8_C9, ang_C9_N8_C5, ang_b1_N8_b2 = [
            math.degrees(i)
            for i in (ang_C13_N8_C5, ang_C13_N8_C9, ang_C9_N8_C5, ang_b1_N8_b2)
        ]

        f_out.write(
            "{:>9}{:>17.3f}{:>17.3f}{:>17.3f}{:>17.3f}\n".format(
                n, ang_C13_N8_C5, ang_C13_N8_C9, ang_C9_N8_C5, ang_b1_N8_b2
            )
        )
