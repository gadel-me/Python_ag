...
def scan_coordinates(lmprst, displace_atoms, frozen_atoms, vt_shift, output, save_step=100000, settings_file=None, non_covalent=None):
    """
    """
...
if __name__ == "__main__":
    ...
    scan_coordinates(ARGS.lmprst, range(31, 61), [15, 16, 17, 19, 21, 23, 45, 46, 47, 49, 51, 53], SHIFT_VECTOR, ARGS.o, settings_file=ARGS.set, non_covalent=ARGS.non_covalent)
