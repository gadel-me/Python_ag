...
def scan_coordinates(lmprst, displace_atoms, frozen_atoms, vt_shift, output, save_step=100000):
    """
    """
...
if __name__ == "__main__":
    ...
    scan_coordinates(ARGS.lmprst, range(31, 61), [25, 26, 28, 55, 56, 58], SHIFT_VECTOR, ARGS.o)
