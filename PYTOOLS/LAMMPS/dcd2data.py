...
parser = argparse.ArgumentParser(
    ...
    description="Convert a frame froma a dcd-file" + "into a data-file.",
)
...
parser.add_argument(
    "-o", "--out", default="DEFAULTNAME", action="store", help="Output file name."
)
...
mydata.read_frames(
    frame=None, to_frame=-1, frame_by="index"
