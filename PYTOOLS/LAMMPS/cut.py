...
parser.add_argument("-dcd",
                    default=None,
                    help="DCD file for additional coordinates")
...
sys.write_lmpdat("{}_out.lmpdat".format(args.lmpdat.rstrip(".lmpdat")), frame_id=-1, title="cut box", cgcmm=True)
