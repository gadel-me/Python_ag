...
parser.add_argument(
    "mae", metavar="*.mae", help="Maestro-file.",
)

parser.add_argument(
    "-nproc", default=4, type=int, help="Number of available CPU-Cores."
)
...
parser.add_argument(
    "-method", default="MP2", help="Level of theory for the gaussian job."
)

parser.add_argument(
    "-basis_set", default="6-311++G**", help="Basis set to use by gaussian."
)
...
parser.add_argument("-charge", default=0, type=int, help="Charge of the molecule.")
...
parser.add_argument("-out", default="DEFAULTNAME", help="Name of output-files.")
...
for frame_id in frame_ids:
    ...
    mae.write_gau(
        args.out + "_{}.gau".format(frame_id),
        frame_id,
