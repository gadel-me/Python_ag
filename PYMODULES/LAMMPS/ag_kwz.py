...
def _test_anneal_equil(data, output=None, xlabel=None, rsquare_thrsh=0.998):
    """
    ...
    qq_normal = ags.qq_test(
        data, rsquare_thrsh=rsquare_thrsh, output=output + "_qq_plot", save_plot=True
    )
